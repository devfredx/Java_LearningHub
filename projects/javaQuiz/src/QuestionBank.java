public class QuestionBank {
    public static Question[] questions = {
            new Question("1. What is the correct way to declare a variable in Java?",
                    new String[]{"A. int myVariable;", "B. variable myVariable;", "C. myVariable = int;",
                            "D. declare myVariable as int;", "E. None of the above."},
                    "A"),
            new Question("2. What is the result of 3 + 5 * 2?",
                    new String[]{"A. 16", "B. 13", "C. 11", "D. 10", "E. None of the above."},
                    "B"),
            new Question("3. Which of the following is NOT a primitive data type in Java?",
                    new String[]{"A. int", "B. double", "C. string", "D. char", "E. boolean"},
                    "C"),
            new Question("4. What keyword is used to define a class in Java?",
                    new String[]{"A. class", "B. interface", "C. struct", "D. object", "E. None of the above."},
                    "A"),
            new Question("5. What does the 'static' keyword mean in Java?",
